...
#     description = descriptions.get(overall_sentiment.toLowerCase(), "Stay mindful and positive.")

#     if overall_sentiment.toLowerCase() in ["sad", "fear", "angry", "disgust"] and overall_score < 0.4:
#         description += " If you're feeling overwhelmed, consider talking to someone or seeking professional help."
